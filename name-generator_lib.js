 ...
 *
 * @param {string} [nounUrl='/nouns.txt']   - URL of the noun list.
 * @param {string} [adjUrl='/adjectives.txt'] - URL of the adjective list.
 * @returns {Promise<string>} The generated name.
 */
export async function generateName(nounUrl = '/nouns.txt', adjUrl = '/adjectives.txt') {
